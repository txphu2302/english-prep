...
export default function App() {
	...
	return (
		<div className='min-h-screen bg-background'>
			...
			{/* Landing page */}
			{currentView === 'landing' && <LandingPage onGetStarted={handleGetStarted} onLogin={handleGoToLogin} />}
			...
			{currentView !== 'landing' && currentView !== 'auth' && (
				<main className='container mx-auto px-4 py-6'>
					{currentView === 'dashboard' && (
						<Dashboard onStartTest={handleStartTest} onGoToTestSelection={handleGoToTestSelection} user={currentUser} />
					)}
					...
					{currentView === 'test' && isSpeakingTest && <SpeakingTest />}
					...
					{currentView === 'profile' && currentUser && <Profile user={currentUser} onUpdateUser={setCurrentUser} />}

					{currentView === 'history' && <History userId={currentUser?.id} />}

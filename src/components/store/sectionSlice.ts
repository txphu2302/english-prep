...
However, remote work also presents challenges. Some employees struggle with isolation and the blurring of boundaries between professional and personal life.`,
	...
	// --- SECTIONS CHO EXAM MOCK MỚI e7 ---
	{
		id: 's7',
		lastEditedBy: 'u1',
		parentId: 'e7',
		direction:
			'IELTS READING – MOCK TEST 1\n\nYou are going to read two short passages. For each passage, answer the questions that follow.',
		difficulty: Difficulty.Beginner,
	},
	{
		id: 's7-1',
		...
		parentId: 's7',
		difficulty: Difficulty.Beginner,
		direction: `PASSAGE 1: STUDYING ABROAD

Many students choose to study abroad to experience a different education system and culture. Living in another country helps them become more independent and improve their language skills.

However, studying abroad can also be challenging. Students may feel homesick and have to adapt to new ways of learning and communicating.`,
	},
	{
		id: 's7-2',
		lastEditedBy: 'u1',
		parentId: 's7',
		difficulty: Difficulty.Beginner,
		direction: `PASSAGE 2: DAILY EXERCISE

Regular exercise is important for maintaining good health. Even simple activities like walking, stretching, or cycling can improve a person's mood and energy levels.

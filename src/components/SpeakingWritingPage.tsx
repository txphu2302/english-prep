			...
			<Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'speaking' | 'writing')} className="flex flex-col -mt-8 relative z-20">
				...
				<div className="container mx-auto px-4 flex justify-center">
					<TabsList className="bg-white/90 backdrop-blur-xl p-2 rounded-full shadow-2xl border border-gray-100/50 w-fit">
						<TabsTrigger
							value="speaking"
							className="rounded-full px-8 py-3 text-base font-semibold text-gray-500 hover:text-gray-900 data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md transition-all flex items-center gap-2"
						>
						...
						<TabsTrigger
							value="writing"
							className="rounded-full px-8 py-3 text-base font-semibold text-gray-500 hover:text-gray-900 data-[state=active]:bg-secondary data-[state=active]:text-white data-[state=active]:shadow-md transition-all flex items-center gap-2"
						>

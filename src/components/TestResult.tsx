      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-8 text-center border border-gray-200">
          ...
          <div className="flex justify-center gap-12 mb-8">
            ...
            <div className="text-center border-l pl-12 border-gray-200">
          ...
          <div className="flex justify-center gap-4">
            <Button onClick={() => navigate('/')} variant="outline" className="px-6">Back to Home</Button>
              ...
              <div key={q.id} className={`bg-white rounded-lg border-l-8 shadow-sm overflow-hidden ${borderClass}`}>
                <div className={`px-6 py-4 flex justify-between items-start ${bgHeaderClass}`}>
                  <div>
                    ...
                    <span className={`font-bold uppercase text-sm px-2 py-1 rounded ${
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-md border">
                      ...
                      <p className={`font-medium ${
                        ...
                        status === 'incorrect' ? 'text-red-600' : 'text-gray-400 italic'
                      }`}>

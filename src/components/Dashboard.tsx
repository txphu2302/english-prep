...
import { BookOpen, Headphones, Mic, PenTool, Target, Clock, TrendingUp, Plus } from 'lucide-react';
	...
	return (
		<div className='space-y-8'>
			...
			<div className='text-center space-y-4'>
				<h2 className='text-3xl font-semibold'>Chào mừng {user?.fullName ?? 'bạn'} 👋</h2>

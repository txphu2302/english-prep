...
const mockTestSuites: TestSuite[] = [
  ...
  },
  {
    ...
    title: 'IELTS Listening - General Training Practice',
    testType: 'ielts',
    skills: ['listening'],
    difficulty: 'intermediate',
    duration: 30,
    questionsCount: 40,
    description: 'Luyện tập kỹ năng nghe với 4 phần: đối thoại hàng ngày và học thuật',
    rating: 4.7,
    completions: 892,
    isNew: true
  },
  {
    id: 'ielts-full-1',
    title: 'IELTS Full Test - Mock Exam 2024',
    testType: 'ielts',
    skills: ['listening', 'reading', 'writing', 'speaking'],
    difficulty: 'advanced',
    duration: 165,
    questionsCount: 120,
    description: 'Bài thi mô phỏng đầy đủ 4 kỹ năng IELTS với thời gian thực tế',
    rating: 4.9,
    completions: 567,
    isPopular: true
  },
  ...
  {
    id: 'toeic-reading-1',
    title: 'TOEIC Reading Comprehension - Advanced',
    testType: 'toeic',
    skills: ['reading'],
    difficulty: 'advanced',
    duration: 75,
    questionsCount: 100,
    description: 'Luyện tập đọc hiểu TOEIC với các văn bản phức tạp và đa dạng',
    rating: 4.5,
    completions: 734
  },
  {
    id: 'ielts-writing-1',
    title: 'IELTS Writing Task 1 & 2 - Academic',
    testType: 'ielts',
    skills: ['writing'],
    difficulty: 'intermediate',
    duration: 60,
    questionsCount: 2,
    description: 'Luyện tập viết IELTS Academic: mô tả biểu đồ và viết luận',
    rating: 4.4,
    completions: 445,
    isNew: true
  },
  {
    id: 'ielts-speaking-1',
    title: 'IELTS Speaking - Part 1: Introduction & Interview',
    testType: 'ielts',
    skills: ['speaking'],
    difficulty: 'intermediate', 
    duration: 5,
    questionsCount: 12,
    description: 'Luyện tập nói IELTS Part 1: trả lời câu hỏi về bản thân và chủ đề quen thuộc',
    rating: 4.8,
    completions: 823,
    isPopular: true
  },
  {
    ...
    duration: 4,
    questionsCount: 1,
    description: 'Luyện tập IELTS Part 2: nói về chủ đề trong 1-2 phút với 1 phút chuẩn bị',
    rating: 4.6,
    completions: 567,
    isNew: true
  },
  {
    ...
    duration: 5,
    questionsCount: 8,
    description: 'Luyện tập IELTS Part 3: thảo luận sâu với các câu hỏi trừu tượng và phân tích',
    rating: 4.7,
    completions: 445
  },
  {
    id: 'ielts-speaking-full',
    title: 'IELTS Speaking - Full Test (All Parts)',
    testType: 'ielts',
    skills: ['speaking'],
    difficulty: 'advanced',
    duration: 15,
    questionsCount: 25,
    description: 'Bài thi nói IELTS đầy đủ 3 phần với AI examiner và feedback chi tiết',
    rating: 4.9,
    completions: 234,
    isPopular: true,
    isNew: true
  ...
  {
    id: 'toeic-speaking-1',
    title: 'TOEIC Speaking - Business Communication',
    testType: 'toeic',
    skills: ['speaking'],
    difficulty: 'intermediate',
    duration: 20,
    questionsCount: 11,
    description: 'Luyện tập nói TOEIC: giao tiếp trong môi trường kinh doanh và công việc',
    rating: 4.5,
    completions: 389
  }
];
...
export function TestsPage({ onStartTest, preselectedTestType, currentUser, onRequestLogin }: TestsPageProps) {
  ...
  const filteredTests = mockTestSuites.filter(test => {
    ...
    return matchesSearch && matchesTestType && matchesDifficulty && matchesSkill;
  });
      ...
      {!currentUser && (
        <Alert className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950">
          ...
          <AlertDescription className="text-blue-800 dark:text-blue-200">
            ...
            {' '}để bắt đầu làm bài thi và theo dõi tiến độ học tập của bạn.
          </AlertDescription>
        </Alert>
      )}
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex space-x-2">
              ...
              <Button
                variant={selectedSkill === 'listening' ? 'default' : 'outline'}
                size="sm"
              ...
              <Button
                variant={selectedSkill === 'reading' ? 'default' : 'outline'}
                size="sm"
              ...
              <Button
                variant={selectedSkill === 'writing' ? 'default' : 'outline'}
                size="sm"
              ...
              <Button
                variant={selectedSkill === 'speaking' ? 'default' : 'outline'}
                size="sm"
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Badge className={getDifficultyColor(test.difficulty)}>
                  ...
                  {test.difficulty === 'intermediate' && 'Trung bình'}
                  {test.difficulty === 'advanced' && 'Nâng cao'}
                </Badge>
              </div>
              ...
              <Button 
                ...
                onClick={() => {
                  ...
                  // Start with the first skill for multi-skill tests
                  const primarySkill = test.skills[0];
                  onStartTest(test.testType, primarySkill, test.id);
                }}
              >
